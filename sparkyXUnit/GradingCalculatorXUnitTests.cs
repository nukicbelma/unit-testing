...
namespace sparky
{
    public class GradingCalculatorXUnitTests
    {
        ...
        public void GradeCalc_failsureScenarios_GetFGrade(int score, int attendance)
        {
            ...
            gradingCalculator.AttendeancePercentage = attendance;
            string result = gradingCalculator.GetGrade();
        ...
        public void GradeCalc_AllGradeLogicalScenarios_GetOutput(int score, int attendance, string expectedResult)
        {
            gradingCalculator.Score = score;
            gradingCalculator.AttendeancePercentage = attendance;
